-- // Panda Hub Blox Fruits - Fluent UI Full
...
local Window = Library:CreateWindow({
    Title = "Panda Hub | Blox Fruits",
    SubTitle = "Fluent UI • Full Logic",
    TabWidth = 160,
...
local Tabs = {
    ...
    Sea = Window:CreateTab({Title = "Sea Event", Icon = "anchor"}),
    Dragon = Window:CreateTab({Title = "Dragon", Icon = "dragon"}),
    Raid = Window:CreateTab({Title = "Raid", Icon = "shield"}),
...
-- Main Tab
Tabs.Main:AddToggle({Title = "Auto Farm Level", Default = false, Callback = function(v) _G.AutoFarm = v end})
Tabs.Main:AddDropdown({Title = "Select Weapon", Values = {"Melee","Sword","Blox Fruit","Gun"}, Default = "Melee", Callback = function(v) _G.SelectWeapon = v end})
Tabs.Main:AddToggle({Title = "Auto Quest", Default = true, Callback = function(v) _G.AutoQuest = v end})

-- Farm Tab
Tabs.Farm:AddToggle({Title = "Auto Material", Callback = function(v) _G.AutoMaterial = v end})
Tabs.Farm:AddToggle({Title = "Auto Farm Chest", Callback = function(v) _G.AutoFarmChest = v end})

-- Sea Event
Tabs.Sea:AddToggle({Title = "Auto Terrorshark", Callback = function(v) _G.TerrorShark = v end})
Tabs.Sea:AddToggle({Title = "Auto Leviathan", Callback = function(v) _G.Leviathan1 = v end})
Tabs.Sea:AddToggle({Title = "Auto Pirate Brigade", Callback = function(v) _G.PGB = v end})

-- Dragon
Tabs.Dragon:AddToggle({Title = "Auto Dragon V1", Callback = function(v) _G.DragoV1 = v end})
Tabs.Dragon:AddToggle({Title = "Auto Dragon V3", Callback = function(v) _G.DragoV3 = v end})
Tabs.Dragon:AddToggle({Title = "Auto Train Dragon V4", Callback = function(v) _G.TrainDrago = v end})
Tabs.Dragon:AddToggle({Title = "Auto Relic Trial", Callback = function(v) _G.Relic123 = v end})

-- Raid
Tabs.Raid:AddToggle({Title = "Auto Start Raid", Callback = function(v) _G.Auto_StartRaid = v end})
Tabs.Raid:AddToggle({Title = "Auto Complete Raid", Callback = function(v) _G.Raiding = v end})

-- Combat
Tabs.Combat:AddToggle({Title = "Kill Aura", Callback = function(v) _G.KillH = v end})
Tabs.Combat:AddToggle({Title = "Aimbot Skill", Callback = function(v) _G.AimMethod = v end})

-- ESP
Tabs.ESP:AddToggle({Title = "ESP Players", Callback = function(v) PlayerEsp = v end})
Tabs.ESP:AddToggle({Title = "ESP Fruits", Callback = function(v) DevilFruitESP = v end})
Tabs.ESP:AddToggle({Title = "ESP Chests", Callback = function(v) ChestESP = v end})

-- Teleport
Tabs.Teleport:AddButton({Title = "Tween To Prehistoric Island", Callback = function() _G.TpDrago_Prehis = true end})

-- Misc
Tabs.Misc:AddToggle({Title = "Infinite Energy", Callback = function(v) getInfinity_Ability("Energy", v) end})
Tabs.Misc:AddToggle({Title = "Infinite Soru", Callback = function(v) _G.InfSoru = v; getInfinity_Ability("Soru", v) end})
Tabs.Misc:AddButton({Title = "Rejoin Server", Callback = function() game:GetService("TeleportService"):Teleport(game.PlaceId) end})
Tabs.Misc:AddButton({Title = "Hop Server", Callback = function() Hop() end})

InterfaceManager:SetLibrary(Library)
InterfaceManager:SetFolder("PandaHub")
InterfaceManager:BuildInterfaceSection(Tabs.Misc)

Library:Notify({Title = "Panda Hub", Content = "Fluent UI Loaded Successfully!", Duration = 6})

-- ==================== PASTE TOÀN BỘ CODE CŨ VÀO ĐÂY ====================
-- ⚠️ Dán toàn bộ nội dung file Panda Hub Banana.lua.txt cũ của bạn (từ "local Y = game.Players;" đến cuối file) vào ngay dưới dòng này:
...
print("✅ Panda Hub Fluent UI Full Loaded!")
